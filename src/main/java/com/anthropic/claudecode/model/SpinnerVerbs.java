 ...
 * Translated from src/constants/spinnerVerbs.ts
 */
public class SpinnerVerbs {
    ...
    /**
     * Get spinner verbs (with optional custom verbs from settings).
     * Translated from getSpinnerVerbs() in spinnerVerbs.ts
     */
    public static List<String> getSpinnerVerbs(List<String> customVerbs, String mode) {
        if (customVerbs == null || customVerbs.isEmpty()) {
        ...
        // Append mode
        List<String> combined = new java.util.ArrayList<>(SPINNER_VERBS);
        combined.addAll(customVerbs);
        return combined;
    }
